...
import com.haier.superepandabletextview.myview.SuperEpandableTextView;
...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.MainViewHolder> {
    ...
    public void onBindViewHolder(MainViewHolder holder, final int position) {
        ...
        holder.expandable_text.setListener(new SuperEpandableTextView.OnExpandStateChangeListener() {
            @Override
    ...
    public class MainViewHolder extends RecyclerView.ViewHolder {
        ...
        SuperEpandableTextView expandable_text;

        public MainViewHolder(View itemView) {
            super(itemView);

            expandable_text= (SuperEpandableTextView) itemView.findViewById(R.id.expandable_text);
        }
    }
}
